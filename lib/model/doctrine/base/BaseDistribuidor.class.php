...
abstract class BaseDistribuidor extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('id', 'string', 15, array('type' => 'string', 'primary' => true, 'length' => '15'));
        ...
        $this->hasColumn('contact1', 'string', 50, array('type' => 'string', 'length' => '50'));
        $this->hasColumn('contact2', 'string', 50, array('type' => 'string', 'length' => '50'));
        $this->hasColumn('contact3', 'string', 50, array('type' => 'string', 'length' => '50'));
        ...
        $this->hasColumn('total_vp', 'integer', 4, array('type' => 'integer', 'length' => '4'));
    }
