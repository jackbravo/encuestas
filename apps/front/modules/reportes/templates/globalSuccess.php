...
{
  echo "nombre tab $i,id tab $i,rango tab $i,estado tab $i,ciudad tab $i,contacto 1 tab $i,contacto 2 tab $i,contacto 3 tab $i,fecha asignacion $i,se contacto al tab $i,fecha contacto tab $i,agente contacto tab $i,se contacto al lead $i,fecha contacto lead $i,agente contacto lead $i,notas $i,num vuelta,";
}
