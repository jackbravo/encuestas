...
CREATE TABLE distribuidor (id INT, name VARCHAR(255), level VARCHAR(50), city VARCHAR(100), state VARCHAR(100), contact1 VARCHAR(100), contact2 VARCHAR(100), contact3 VARCHAR(100), tally INT, performance INT, m1_vp INT, m1_ro INT, m2_vp INT, m2_ro INT, m3_vp INT, m3_ro INT, PRIMARY KEY(id)) ENGINE = INNODB;
