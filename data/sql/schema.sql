...
CREATE TABLE encuesta (id INT AUTO_INCREMENT, agente_id INT, viewer_id INT, last_dist_id INT, nombre VARCHAR(255) NOT NULL, apellido_p VARCHAR(255) NOT NULL, apellido_m VARCHAR(255) NOT NULL, edad INT NOT NULL, genero VARCHAR(1) NOT NULL, telefono VARCHAR(50) NOT NULL, celular VARCHAR(50), email VARCHAR(50), estado_id INT NOT NULL, ciudad VARCHAR(50) NOT NULL, municipio VARCHAR(50) NOT NULL, colonia VARCHAR(50) NOT NULL, calle VARCHAR(50) NOT NULL, numero VARCHAR(50) NOT NULL, cp INT NOT NULL, notas VARCHAR(255) DEFAULT '' NOT NULL, created_at DATETIME, updated_at DATETIME, INDEX agente_id_idx (agente_id), INDEX viewer_id_idx (viewer_id), INDEX last_dist_id_idx (last_dist_id), INDEX estado_id_idx (estado_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE seguimiento (id INT AUTO_INCREMENT, distribuidor_id INT, lead_id INT, agente_id INT, localizo_dist TINYINT(1) DEFAULT '0' NOT NULL, fecha_localizo_dist DATETIME, localizo_lead TINYINT(1) DEFAULT '0' NOT NULL, fecha_localizo_lead DATETIME, intento SMALLINT NOT NULL, status TINYINT DEFAULT 0 NOT NULL, notas VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX localizo_intento_idx_idx (status, intento), INDEX distribuidor_id_idx (distribuidor_id), INDEX lead_id_idx (lead_id), INDEX agente_id_idx (agente_id), PRIMARY KEY(id)) ENGINE = INNODB;
