...
CREATE TABLE seguimiento (id INT AUTO_INCREMENT, distribuidor_id INT, lead_id INT, agente_id INT, localizo_dist TINYINT(1) DEFAULT '0' NOT NULL, fecha_localizo_dist DATETIME, localizo_agente TINYINT(1) DEFAULT '0' NOT NULL, fecha_localizo_agente DATETIME, intento INT NOT NULL, notas VARCHAR(255), created_at DATETIME, updated_at DATETIME, INDEX intento_idx_idx (intento), INDEX distribuidor_id_idx (distribuidor_id), INDEX lead_id_idx (lead_id), INDEX agente_id_idx (agente_id), PRIMARY KEY(id)) ENGINE = INNODB;
